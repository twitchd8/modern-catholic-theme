 ...
 */
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/generic-parish-hero-placeholder.png","alt":"Generic parish church placeholder","dimRatio":70,"overlayColor":"black","minHeight":640,"minHeightUnit":"px","contentPosition":"center center","align":"full"} -->
<div class="wp-block-cover alignfull" style="min-height:640px"><img class="wp-block-cover__image-background" alt="Generic parish church placeholder" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/generic-parish-hero-placeholder.png" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-black-background-color has-background-dim-70 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"type":"constrained","contentSize":"58rem"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"className":"has-white-color has-text-color","style":{"typography":{"textAlign":"center"}},"textColor":"white","fontSize":"medium"} -->
<p class="has-text-align-center has-white-color has-text-color has-medium-font-size">A welcoming Catholic parish community</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":1,"style":{"typography":{"textAlign":"center"}},"textColor":"white","fontSize":"xx-large"} -->
<h1 class="wp-block-heading has-text-align-center has-white-color has-text-color has-xx-large-font-size">Welcome. Come worship with us.</h1>
<!-- /wp:heading -->
