...
function modern_catholic_render_color_style_guide_page() {
	...
	<div class="wrap modern-catholic-style-guide">
		...
		<p><?php esc_html_e( 'Select a Group or Column block, then choose Raised Panel in its Styles controls or enter one of the class names below under Advanced → Additional CSS class(es). Enter only the class name, without a period. Each class gives the block a raised Surface background, a subtle border and shadow, and a colored strip along its top edge.', 'modern-catholic' ); ?></p>
		<table class="widefat striped modern-catholic-style-guide__classes">
			<caption class="screen-reader-text"><?php esc_html_e( 'Raised panel class examples', 'modern-catholic' ); ?></caption>
			<thead>
				<tr>
					<th scope="col"><?php esc_html_e( 'Class to enter', 'modern-catholic' ); ?></th>
					<th scope="col"><?php esc_html_e( 'Top strip', 'modern-catholic' ); ?></th>
					<th scope="col"><?php esc_html_e( 'Example use', 'modern-catholic' ); ?></th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<th scope="row"><code>mc-card</code></th>
					<td><?php esc_html_e( 'Accent (default)', 'modern-catholic' ); ?></td>
					<td><?php esc_html_e( 'A general parish announcement or office-hours panel.', 'modern-catholic' ); ?></td>
				</tr>
				<tr>
					<th scope="row"><code>mc-card-accent1</code></th>
					<td><?php esc_html_e( 'Accent', 'modern-catholic' ); ?></td>
					<td><?php esc_html_e( 'A Mass Times panel that deserves a gentle highlight.', 'modern-catholic' ); ?></td>
				</tr>
				<tr>
					<th scope="row"><code>mc-card-accent2</code></th>
					<td><?php esc_html_e( 'Secondary', 'modern-catholic' ); ?></td>
					<td><?php esc_html_e( 'A parish ministries or community-life panel.', 'modern-catholic' ); ?></td>
				</tr>
				<tr>
					<th scope="row"><code>mc-card-accent3</code></th>
					<td><?php esc_html_e( 'Primary', 'modern-catholic' ); ?></td>
					<td><?php esc_html_e( 'A registration or important contact-information panel.', 'modern-catholic' ); ?></td>
				</tr>
			</tbody>
		</table>
		<p><?php esc_html_e( 'The Accent, Secondary, and Primary strip colors come from the active palette, so these classes follow future style variations. The Raised Panel choice in Styles applies the default Accent treatment automatically; you do not need to type its generated is-style-mc-card class. If you set a block background or border color in the editor, that explicit choice remains in control.', 'modern-catholic' ); ?></p>
